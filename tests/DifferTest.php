...
class DifferTest extends TestCase
{
    ...
    {
        $diff = $diff = \Differ\Differ\genDiff('./tests/fixtures/before1.json','./tests/fixtures/after1.json');
        $this->assertEquals(file_get_contents('./tests/fixtures/trueResult1'),  $diff);

    }
    public function testGenDiff()
    {
        $diff = \Differ\Differ\genDiff('./tests/fixtures/before.json','./tests/fixtures/after.json');
